const CACHE='snowtech-alpine-v079';
const ASSETS=['./','./index.html','./manifest.webmanifest','./snowtech-logo.png','./snowtech-icon-192.png','./snowtech-icon-512.png','./apple-touch-icon.png'];
